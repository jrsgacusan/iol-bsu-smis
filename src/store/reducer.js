...
const initialState = {
  ...
  isModalShown: false, //for modal sheets
...
const reducer = (state = initialState, action) => {
  ...
  switch (action.type) {
    ...
    case actionTypes.ADD_BILLING:
      const updatedBillings = state.billings.concat(action.data);
      return {
        ...state,
        billings: updatedBillings,
      };
    case actionTypes.REMOVE_BILLING:
      const updated = state.billings.filter(
        (billing) => billing.paymentId !== action.data
      );
